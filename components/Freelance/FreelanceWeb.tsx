...
// Combined projects data - Your original 3 projects + 2 new web projects
const projects = [
  {
    id: 1,
    title: 'Naukri Helping',
    description: 'A comprehensive resource for government job notifications (Sarkari Naukri), admit cards, and results. Dynamic job portal with information architecture.',
    technologies: ['Job Portal', 'Information', 'Dynamic', 'Web Development'],
    github: null,
    live: 'https://naukrihelping.com/',
    image: '/images/naukri-helping.png'
  },
  {
    id: 2,
    title: 'SRZ Shoppy',
    description: 'Online shopping platform featuring a wide range of products with a user-friendly interface. Full-featured e-commerce solution with responsive design.',
    technologies: ['E-commerce', 'Shopping', 'Responsive', 'Web Development'],
    github: null,
    live: 'https://srzshoppy.in/',
    image: '/images/srz-shoppy.png'
  },
  {
    id: 3,
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-red-500 rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-pulse"></div>
        <div className="absolute top-1/2 left-1/2 w-96 h-96 bg-blue-400 rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-pulse"></div>
      </div>
        ...
        <div className={`space-y-12 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
              ...
              >
                <div className="grid md:grid-cols-2 gap-0">
                  ...
                  <div className="relative h-80 md:h-auto overflow-hidden group">
                    {!imageError[projects[currentIndex].id] ? (
                      <Image
                        key={`${projects[currentIndex].id}-${currentIndex}`}
                      ...
                      <div className="absolute inset-0 bg-gradient-to-br from-purple-600 via-red-500 to-blue-400">
          ...
          <div className="grid grid-cols-2 md:grid-cols-5 gap-4 max-w-5xl mx-auto pt-8">
            {projects.map((project, index: number) => (
              ...
              >
                <h4 className={`text-sm font-bold ${index === currentIndex ? 'text-white' : 'text-gray-400'
                  }`}>
                  {project.title}
                </h4>
              </button>
