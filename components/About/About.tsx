...
const personalInfo = {
  name: 'Ankit Jha',
  title: 'Full Stack Developer & Multimedia Specialist',
  location: 'India',
  experience: '2+ Years of Professional Experience',
  bio: 'With over 2 years of hands-on experience, I specialize in crafting high-performance web applications using the MERN stack while blending creativity through professional video production. I focus on building solutions that are not only functional but visually compelling and conversion-driven.'
}
        ...
        <div className={`grid lg:grid-cols-2 gap-12 items-center transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                ...
                {videoError && (
                  <div className="absolute inset-0 bg-gradient-to-br from-purple-600 via-red-500 to-blue-400 flex items-center justify-center">
                    <div className="text-center space-y-4">
                      ...
                      <p className="text-white text-2xl font-bold">Building Digital Experiences</p>
                    </div>
                  </div>
                )}
              </div>
          ...
          <div className={`space-y-8 transition-all duration-1000 delay-400 ${isVisible ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-10'}`}>
            ...
            <div className="space-y-5 text-gray-300 leading-relaxed text-lg">
              <p>
                Hi, I&apos;m <span className="text-purple-400 font-semibold">{personalInfo.name}</span>, a passionate{' '}
                <span className="text-blue-400 font-semibold">Full Stack Developer</span> and{' '}
                <span className="text-red-400 font-semibold">Video Editor</span> based in {personalInfo.location},
                with <span className="text-green-400 font-semibold">{personalInfo.experience}</span>.
              </p>

              <p>
                {personalInfo.bio} I thrive at the intersection of clean code, modern UI/UX, and impactful visual storytelling.
              </p>

              <p>
                I&apos;ve worked with startups, creators, and businesses to build scalable web platforms, landing pages,
                admin dashboards, and high-engagement video content tailored for growth and brand identity.
              </p>

              <p>
                As a freelancer, my mission is simple — to deliver reliable, scalable, and visually striking digital
                solutions that help clients stand out in a competitive online world.
              </p>
            </div>
